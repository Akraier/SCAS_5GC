...
reverse_procedure_code_values = {v: k for k, v in NGAP_procedure_code_values.items()}
...
class NGAP:
    ...
    def build_ngap_pdu(self, ngap_dict):
        ...
        try:
            ...
            pdu += first_byte.to_bytes(1, byteorder='big')   
            #second byte is procedure code
            procedure_code = reverse_procedure_code_values[pdu_data["procedure_code"]] #HERE
        ...
        try:
            ...
            for i in range(protocol_ies):
                ...
                #update dictionary
                    ...
                    """ASN1 Ber len encoding for IEs > 127: 0x80 + 1 byte length"""
